def encode_dc_huffman(dc_diff):
    # таблица хаффмана для DC
    huffman_table = {
        0: "00",
        1: "010",
        2: "011",
    ...
    for value in dc_diff:
        if value == 0:
            ...
            if value > 0:
                ...
                pos = format(abs_val, f'0{size}b')
                amplitude = ''.join('1' if b == '0' else '0' for b in pos)
        huff = huffman_table[size]
        encoded.append(huff + amplitude)

    return encoded



def encode_ac_huffman(ac_rle_vlc):
    huffmann_ac = {
        0x00: "1010",
        0xF0: "11111111001",
    ...
    encoded = []
    for runsize, amplitude in ac_rle_vlc:
        a = huffmann_ac[runsize]
        encoded.append(a + amplitude)
    return encoded
